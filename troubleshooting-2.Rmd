...
tibble(movieLens) #Added to satisfy requirement 'Have a quick look at the tibble, using a dplyr function
```
...
filter(movieLens, !genres == "Drama")
filter(movieLens, year > 2001) ## change to > 2001 as we need "after" year 2000
